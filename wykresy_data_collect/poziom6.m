...
ylabel('Y');
%test point poziom1
x_tp = [13.6,17.1,23.4,27.8,38.9,58.4,79,87.5,101.6,113.2]
y_tp = [5.5,7.1,7.7,12.6,7.2,7.4,11.6,5.8,7.5,7.8]
...
xlabel('X [m]');
ylabel('Y [m]');
title('Rozkład punktów dla 6 piętra budynku stare ETI Politechnika Gdańska');
grid on;

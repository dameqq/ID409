...
ylabel('Y');
%test point poziom1
x_tp = [7.6,17.04,27.5,46.4,106.6,101.6,97.6,92.9,89,85.8]
y_tp = [6.05,7.2,9.85,7.1,6,7,6.1,6.7,7,6.8]
...
xlabel('X [m]');
ylabel('Y [m]');
title('Rozkład punktów dla 1 piętra budynku stare ETI Politechnika Gdańska');
grid on;

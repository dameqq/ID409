...
ylabel('Y');
%test point poziom1
x_tp = [13,16.1,28.2,73.5,71.5,60.5,79,87.4,102.2,112.2]
y_tp = [6.65,5.95,8,5.3,8.2,7.5,9,5.7,5.9,7.8]
...
xlabel('X [m]');
ylabel('Y [m]');
title('Rozkład punktów dla 5 piętra budynku stare ETI Politechnika Gdańska');
grid on;

...
ylabel('Y');
%test point poziom1
x_tp = [13.3,17.85,21.7,28.6,93.1,80,72.5,112.2,113.2,57.4]
y_tp = [7.2,5.55,7.8,8,5.55,10.6,5.3,7.8,6.5,7.5]
...
xlabel('X [m]');
ylabel('Y [m]');
title('Rozkład punktów dla 4 piętra budynku stare ETI Politechnika Gdańska');
grid on;
